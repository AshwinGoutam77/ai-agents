...
const ScopeOfWorkChat = ({ token }) => {
  ...
  const createSession = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://api.devwings.com/scope-of-work-generator/sessions",
        {
          method: "POST",
          headers: {
  ...
  const initialFeed = async (sessionId, projectName) => {
    try {
      ...
      const res = await fetch(
        `https://api.devwings.com/scope-of-work-generator/sessions/${sessionId}/feed`,
        {
          method: "POST",
          headers: {
...
export default ScopeOfWorkChat;
